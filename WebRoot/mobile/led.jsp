...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function runLed(){
			...
			$.post("http://rmp.cellbot.cn/cgi/message/send.api", 
					{action:'308',content:"0," + ledId + "," + time,receiver:receiver,API_AUTH_KEY:'7215EE9C7D9DC229D2921A40E899EC5F'},
					  function(data){
    ...
    <div class="input-group" style="margin-top: 20px;width: 100%;">
		...
		<input type="text" class="form-control"  id="ledId"  maxlength="32" style="display: inline; width: 100%; height: 42px;"/>
	</div>
	...
	<div class="panel-footer"  style="margin-top: 20px;">
	     <button type="button" class="btn btn-success btn-lg" onclick="runLed()"  style="width: 200px;">

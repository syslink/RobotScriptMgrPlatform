...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function loadScript(){
			showProcess('加载中......');
			var type = $("#Ttype").val();
			$.post("<%=basePath%>/cgi/script/selectlist.api", {uid:uid,type:type,role:4,API_AUTH_KEY:'7215EE9C7D9DC229D2921A40E899EC5F'},
				 function(data){
					$("#sid").empty();
					var length = data.dataList.length;
					for(var i=0;i<length;i++){
		...
		function  doexecute(){
			...
			var receiver = $('#deviceId1').val() + "," + $('#deviceId2').val() + "," + $('#deviceId3').val() + "," + $('#deviceId4').val();
		...
		{
			 $("#content").val(action);
			 $("#receiver").val($("#deviceId1").val()+","+$("#deviceId2").val()+","+$("#deviceId3").val()+","+$("#deviceId4").val());
